...
**AI is our ally, not our replacement.**  
_We experiment with responsibility, expertise, and collaboration._
...
- **Encourage collaboration among diverse teams**
- **Strive for transparency in AI processes**
- **Accountability**
- **Trustworthiness**
- **Inclusiveness**
...
## Manifesto — Key Principles (English Summary)
...
Want to improve the manifesto or offer a translation?  
Read the [CONTRIBUTING.md](CONTRIBUTING.md) guide and open a pull request!

---

**License:** MIT  
**Contacts:** Open an Issue or Pull Request to get in touch.
